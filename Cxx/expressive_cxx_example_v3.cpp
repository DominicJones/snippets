// Copied from:
// http://web.archive.org/web/20110202141956/http://cpp-next.com:80/wp-content/uploads/2011/01/08-source-1.cpp_.txt
...
namespace linear_algebra
{
  ...
  struct Optimize:
    or_<
      ...
      >,
      when<
        plus<DistributeIndex, DistributeIndex>,
        _make_plus(Distribute(_left_, _state), Distribute(_right_, _state))
      >
    >
  {};
}
